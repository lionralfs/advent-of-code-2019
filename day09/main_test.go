...
func TestQuine(t *testing.T) {
	...
	program := NewProgram([]int{109, 1, 204, -1, 1001, 100, 1, 100, 1008, 100, 16, 101, 1006, 101, 0, 99})
	...
	for ; ; i++ {
		...
		if output != want[i] {
			t.Errorf("Got %v, want %v", output, want[i])
		}
	}
}

func Test16DigitOutput(t *testing.T) {
	program := NewProgram([]int{1102, 34915192, 34915192, 7, 4, 7, 99, 0})

	output, _ := program.Run()
	_, done := program.Run()
	...
	if !done {
		t.Errorf("Expected to be done after a single output")
	}
}

func TestLargeNumberOutput(t *testing.T) {
	program := NewProgram([]int{104, 1125899906842624, 99})
...
func TestRegularProgram(t *testing.T) {
	tests := []struct {
		intcode []int
		inputs  []int
		want    int
	...
	for i, test := range tests {
		program := NewProgram(test.intcode)
		program.inputs = test.inputs
...
func TestInputWithRelativeInputMode(t *testing.T) {
	program := NewProgram([]int{203, 19, 99})
	program.inputs = []int{12}
	program.offset = 2000

	_, done := program.Run()

	want := 12
	output := program.code[2019]
...
func TestBaseIncrease(t *testing.T) {
	program := NewProgram([]int{109, 19, 204, -34, 99})
	program.code[1985] = 12
	program.offset = 2000
...
func Test1(t *testing.T) {
	program := NewProgram([]int{1102, 34463338, 34463338, 63, 99})

	program.Run()

	want := 34463338 * 34463338
	output := program.code[63]
...
func Test2(t *testing.T) {
	program := NewProgram([]int{1102, 34463338, 34463338, 63, 1007, 63, 34463338, 63, 99})
...
func Test3(t *testing.T) {
	program := NewProgram([]int{1102, 34463338, 34463338, 63, 1007, 63, 34463338, 63, 1005, 63, 53, 99})
